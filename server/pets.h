...
public:
    attack_pet() {}
    virtual void physical_normal_attack(Pet *) = 0;
    void upgrade();
};

//音速犬
class sonic_dog : attack_pet
{
public:
    sonic_dog(int _level)
    {
        name = "音速犬";
        level = _level;
        hp = 250 + (level - 1) * 30;
...
//烈火战神
class blaze_god_of_war : attack_pet
{
public:
    blaze_god_of_war(int _level)
    {
        name = "烈火战神";
        level = _level;
        hp = 250 + (level - 1) * 30;
